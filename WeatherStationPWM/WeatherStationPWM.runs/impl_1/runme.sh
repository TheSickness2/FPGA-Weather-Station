...
HD_PWD='C:/Xilinx/Projects/WeatherStationPWM/WeatherStationPWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_vardisp3_arty.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_vardisp3_arty.tcl -notrace
