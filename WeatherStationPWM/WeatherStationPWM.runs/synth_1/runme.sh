...
HD_PWD='C:/Xilinx/Projects/WeatherStationPWM/WeatherStationPWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_vardisp3_arty.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_vardisp3_arty.tcl
